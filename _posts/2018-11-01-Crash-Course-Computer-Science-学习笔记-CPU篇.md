...
![1.png](http://tva1.sinaimg.cn/large/007RDtggly1gw9m8cgr0wj30jg08k0yu.jpg)        
指令表：前4位是操作码，后4位是内存地址或寄存器，表示数据来自哪里。     
![2.png](http://tva1.sinaimg.cn/large/007RDtggly1gw9m971unyj30m80cjgy4.jpg)      
解码阶段(Decode Phase)：指令由控制单元内的逻辑电路进行解码      
![3.png](http://tva1.sinaimg.cn/large/007RDtgggy1gw9mb3dkocj30m80d37f1.jpg)      
执行：把检查指令的电路输出连到RAM的RE线，把指令后4位发送到地址线，读出数据到寄存器A       
![4.png](http://tva1.sinaimg.cn/large/007RDtgggy1gw9mbw1vn4j30m80crnas.jpg)         
加载数据到A后指令完成，关闭所有线路，准备取下一条指令；IAR+1, 执行阶段就此结束。              
由于解码电路太繁琐，进一步抽象控制单元：         
![5.png](http://tva1.sinaimg.cn/large/007RDtgggy1gw9mcjk88dj30m80d1gwz.jpg)        
ADD B, A指令:    B + A → TR  →  A           
相加的结果不能直接写入寄存器A, 因为A连着ALU的输入，会导致新的sum不断进入ALU相加形成死循环；        
需要一个临时寄存器TR保存相加的结果，关闭ALU, 然后把TR的值写入目标寄存器A        
![6.png](http://tva1.sinaimg.cn/large/007RDtgggy1gw9mdnaceej30m80cjk4g.jpg)  
STORE A 1101 指令：把地址1101传给RAM, 打开WE线，同时打开寄存器A的RE线           
![7.png](http://tva1.sinaimg.cn/large/007RDtgggy1gw9meqr1p9j30m80cpgyp.jpg)
...
![8.png](http://tva1.sinaimg.cn/large/007RDtgggy1gw9mg084y4j30m80d4wrq.jpg)    
...
![9.png](http://tva1.sinaimg.cn/large/007RDtggly1gw9mhaytbfj30p00e8ao3.jpg)      
...
![10.png](http://tva1.sinaimg.cn/large/007RDtggly1gw9mn904bbj30m80eak34.jpg)       
## 缓存(Cache)      
...
![11.png](http://tva1.sinaimg.cn/large/007RDtggly1gw9mppp2scj30m80csk2f.jpg)      
...
![12.png](http://tva1.sinaimg.cn/large/007RDtgggy1gw9mrqtgjij30m80edtl5.jpg)          
...
![13.png](http://tva1.sinaimg.cn/large/007RDtgggy1gw9msniep5j30m80d8qe3.jpg)        
...
## 多核 (multi-core)     
![14.png](http://tva1.sinaimg.cn/large/007RDtgggy1gw9mzu0dowj30m80c8ws8.jpg)        
...
![15.png](http://tva1.sinaimg.cn/large/007RDtgggy1gw9n1p7w6hj30m80c5jzz.jpg)         
